     ...
     <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
               <div class="modal-body" style="padding:0;z-index:20">
                    ...
                    <div class="row">
                         <div class="tab-content" style="margin:0px 15px 0px 15px">
                              <div id="general_modal_v" role="tabpanel" class="tab-pane active">
                              ...
                              <div id="destino_moda_v" role="tabpanel" class="tab-pane">
                                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background:#363352;padding:0" id="seccion_destino">
                                   </div>
                              </div>
