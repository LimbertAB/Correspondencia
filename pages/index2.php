        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#revenue-chart" data-toggle="tab">Zona</a></li>
              <li><a href="#sales-chart" data-toggle="tab">Rosquilla</a></li>
              <li class="pull-left header"><i class="fa fa-inbox"></i>Correspondencias</li>
            </ul>
