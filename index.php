...
<script src="dist/js/notifIt.js"></script>
</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    
    <a href="#"><b>SISTEMA</b><br>CORRESPONDENCIAS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    if (isset($_SESSION['mensaje'])) {
      ...
      <script type="text/javascript">
        notif({
          msg: "<b>Error!</b> Usuario o contraseña incorrecto!",
          type: "error",
          position: "center"
        });
      </script>
    ...
    <form action="db/validacion.php" method="post">
      ...
      <div class="row">
        ...
        <div style="width: 90px; margin: 0 auto;">
          <input type="submit" name="iniciar" class="btn btn-primary btn-block" value="Ingresar">
        </div>
        <!-- /.col -->
      </div>
    </form>
