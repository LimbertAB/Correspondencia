function reg_usuario(){
  ...
  function reg_adjunto(){
    ...
    //Registro de remitentes
        function reg_remitente(){
            var datos=$('#frmaremitente').serialize();
            $.ajax({
                type: "POST",
                url: "../crud/insert.php",
                data: datos,
                success: function(resp){
                    ...
                    location.href = "remitentes.php";
                        ...
                        alert('Ocurrio un error acuda a deaprtamento de sistemas');
                            ...
                            if (resp==1) {
                                alert("nombre esta vacio");
                                $(ok_cargo7).addClass('form-group has-error');
                            }else{
                                if (resp==3) {
                                    alert("apellidos esta vacio");
                                    $(ok_cargo8).addClass('form-group has-error');

                                }
                                else{
                                    if (resp==4) {
                                        alert("cedula esta vacio");
                                        $(ok_cargo9).addClass('form-group has-error');
                                    }
                                    else{
                                        alert("ya existe cedula"+resp);
                                        $(ok_cargo9).addClass('form-group has-error');
                                    }
                                }
                            }
